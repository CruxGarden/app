...
import { createGardenNotebookStorage } from "../garden/notebook-storage";
...
// Crux Garden: the Crux's notebook/ folder is the workspace (src/garden/notebook-storage.ts).
export const notebookStorage: NotebookStorage = (typeof window !== "undefined" && window.__CRUX_GARDEN__)
  ? createGardenNotebookStorage()
  : isTauri()
