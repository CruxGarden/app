...
export const downloadFile = (blob: Blob, filename: string): void => {
  // Inside Crux Garden the result is saved to the Crux instead of downloaded (src/js/garden/bridge.ts).
  if ((window as unknown as { gardenDownload?: (b: Blob, f: string) => boolean }).gardenDownload?.(blob, filename)) return;
