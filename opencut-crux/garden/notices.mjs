...
for (const name of ["opencut-wasm", "mediabunny"])
	add(join(root, "node_modules", name));
let text =
	"OpenCut local build dependency notices.\nUpstream editor MIT license: ../LICENSE. Source and pinned lockfile accompany this runtime.\n";
