...
export async function startGarden() {
  ...
  async function command(value) {
    if (hydrating || !app) throw new Error('Wait for the diagram editor to open.');
    await save();
