...
const garden = typeof window !== 'undefined' ? await window.gardenReady : null;
const driver = () => garden?.driver ?? window.localStorage;
const hasStorage = (): boolean => typeof window !== 'undefined' && !!driver();
