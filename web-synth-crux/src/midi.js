...
function __wbg_adapter_22(arg0, arg1, arg2) {
    wasm._dyn_core_17c5c806d64cb78___ops__function__FnMut_______Output______as_wasm_bindgen_c7104183a59ca42a___closure__WasmClosure___describe__invoke___wasm_bindgen_c7104183a59ca42a___JsValue_____(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Uint8Array}
*/
export function write_to_midi(name, note_data) {
    try {
        ...
        wasm.write_to_midi(retptr, ptr0, len0, ptr1, len1);
...
*/
export function load_midi_to_raw_note_bytes(file_bytes, info_cb, note_cb) {
    const ptr0 = passArray8ToWasm0(file_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.load_midi_to_raw_note_bytes(ptr0, len0, addHeapObject(info_cb), addHeapObject(note_cb));
...
* @returns {number}
*/
export function create_msg_handler_context(play_note, release_note, pitch_bend, mod_wheel, generic_control_handler) {
    const ret = wasm.create_msg_handler_context(addHeapObject(play_note), addHeapObject(release_note), isLikeNone(pitch_bend) ? 0 : addHeapObject(pitch_bend), isLikeNone(mod_wheel) ? 0 : addHeapObject(mod_wheel), isLikeNone(generic_control_handler) ? 0 : addHeapObject(generic_control_handler));
    return ret >>> 0;
}
...
*/
export function drop_msg_handler_ctx(ctx_ptr) {
    wasm.drop_msg_handler_ctx(ctx_ptr);
}
...
* @param {number} ctx_ptr
*/
export function handle_midi_evt(evt_bytes, ctx_ptr) {
    const ptr0 = passArray8ToWasm0(evt_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.handle_midi_evt(ptr0, len0, ctx_ptr);
}
...
function __wbg_adapter_60(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_c7104183a59ca42a___convert__closures__invoke2_mut___wasm_bindgen_c7104183a59ca42a___JsValue__wasm_bindgen_c7104183a59ca42a___JsValue_____(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper270 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 127, __wbg_adapter_22);
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('midi_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
