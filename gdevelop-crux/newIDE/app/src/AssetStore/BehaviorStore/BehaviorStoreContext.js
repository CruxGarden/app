...
export const BehaviorStoreContext: React.Context<BehaviorStoreState> =
  React.createContext<BehaviorStoreState>({
    filters: null,
    searchResults: null,
    fetchBehaviors: () => {},
    error: null,
...
export const BehaviorStoreStateProvider = ({
  ...
  const searchResults: ?Array<SearchResult<BehaviorShortHeader>> =
