...
export const controlCatalogue: ComponentDefinition[] = [
  component('rectangle', 'Rectangle', ['Common', 'Containers'], 'rectangle', 180, 110, {
    fill: '#ffffff',
    stroke: '#1f2937',
  }),
  component('button', 'Button', ['Common', 'Forms'], 'button', 112, 40, {
    text: 'Button',
    fill: '#ffffff',
  }),
  component('circleButton', 'Circle Button', ['Common', 'Forms'], 'CirclePlus', 72, 72, {
    text: '',
    fill: '#ffffff',
    fontSize: 30,
    showBorder: true,
  }),
  component('pointyButton', 'Pointy Button', 'Forms', 'ChevronLeft', 150, 44, {
    text: 'Button',
    fill: '#ffffff',
    variant: 'left',
    showBorder: false,
  }),
  component('multilineButton', 'Multiline Button', 'Forms', 'MousePointer2', 170, 54, {
    text: 'Multiline Button\nSecond line of text',
    fill: '#ffffff',
  }),
  component('helpButton', 'Help Button', 'Forms', 'CircleHelp', 60, 60, {
    text: '?',
    fill: '#ffffff',
    fontSize: 30,
  }),
  component('icon', 'Icon', ['Common', 'Media'], 'icon', 64, 64, {
    icon: 'Plus',
    stroke: '#111827',
    textColor: '#111827',
  }),
  component('iconText', 'Icon and Text', ['Common', 'Media'], 'BadgeInfo', 110, 90, {
    icon: 'Square',
    text: 'Icon Name',
    stroke: '#111827',
    textColor: '#111827',
  }),
  component('stickyNote', 'Comment', 'Markup', 'stickyNote', 180, 160, {
    text: 'A comment',
    fill: '#fff2a8',
    fontSize: 16,
  }),
  component('stickyNote', 'Sticky Note', 'Markup', 'stickyNote', 180, 160, {
    text: 'A sticky note',
    fill: '#fff2a8',
    fontSize: 16,
  }),

  component('textLabel', 'Label', ['Common', 'Text'], 'Type', 180, 34, {
    text: 'Some text',
    fontSize: 14,
  }),
  component('textTitle', 'Title', 'Text', 'Heading1', 240, 48, {
    text: 'A Big Title',
    fontSize: 28,
  }),
  component('textSubtitle', 'Text Subtitle', 'Text', 'Heading2', 220, 42, {
    text: 'A Subtitle',
    fontSize: 22,
  }),
  ...
  component('link', 'Link', ['Common', 'Text'], 'Link', 120, 34, {
    text: 'a link',
    textColor: '#2563eb',
    fontSize: 14,
  }),
  component('squigglyParagraph', 'Squiggly Paragraph', ['Common', 'Text'], 'AlignLeft', 250, 86, {
    text: 'A paragraph of text.\nA second row of text.',
  }),

  component('checkbox', 'Checkbox', ['Common', 'Forms'], 'checkbox', 150, 32, {
    text: 'Checkbox',
    checked: false,
  }),
  ...
  component('radioButton', 'Radio Button', ['Common', 'Forms'], 'CircleDot', 160, 28, {
    text: 'Radio Button',
    checked: false,
    fontSize: 14,
  }),
  component('radioButtonGroup', 'Radio Button Group', ['Common', 'Forms'], 'ListChecks', 210, 126, {
    options: ['option 1', 'option 2', 'option 3'],
    text: 'Radio Group',
  }),
  component('dropdown', 'Dropdown', 'Forms', 'dropdown', 180, 40, {
    text: 'Choose...',
    options: ['First', 'Second', 'Third'],
  }),
  component('comboBox', 'ComboBox', ['Common', 'Forms'], 'ChevronDownSquare', 180, 40, {
    text: 'ComboBox',
    options: ['First', 'Second', 'Third'],
    showScrollbar: true,
  }),
  component('textbox', 'Textbox', 'Forms', 'textbox', 190, 40, { text: 'Text input' }),
  component('textInput', 'Text Input', ['Common', 'Forms'], 'TextCursorInput', 190, 40, {
    text: '',
    placeholder: 'Text input',
    showBorder: true,
    opacity: 100,
  }),
  component('textArea', 'Text Area', ['Common', 'Forms'], 'Text', 230, 120, {
    text: '',
    showBorder: true,
    showScrollbar: true,
    opacity: 100,
  }),
  component('searchBox', 'Search Box', 'Forms', 'Search', 190, 36, {
    text: '',
    placeholder: 'search',
  }),
  component('searchBoxVoice', 'Search Box + Mic', 'Forms', 'Mic', 210, 36, {
    text: '',
    placeholder: 'search',
  }),
  ...
  component('onOffSwitch', 'Switch', 'Forms', 'ToggleRight', 108, 56, {
    checked: true,
    fill: '#6cc24a',
  }),
  component('progressBar', 'Progress Bar', 'Forms', 'BatteryMedium', 170, 28, { value: 45 }),
  component('progressBarIndeterminate', 'Progress (Ind.)', 'Forms', 'MoreHorizontal', 170, 28, {
  ...
  component('buttonBar', 'Button Bar', 'Navigation', 'buttonBar', 240, 40, {
    options: ['One', 'Two', 'Three'],
    activeIndex: 0,
  }),
  component('vTabs', 'Vertical Tabs', 'Navigation', 'PanelLeft', 150, 160, {
    options: ['First Tab', 'Second Tab', 'Third Tab', 'Fourth Tab'],
    activeIndex: 1,
  }),
  component('linkBar', 'Link Bar', 'Navigation', 'Link', 250, 38, {
    options: ['Home', 'Products', 'Company', 'Blog'],
  }),
  component('breadcrumbs', 'Breadcrumbs', 'Navigation', 'ChevronRight', 240, 34, {
    options: ['Home', 'Products', 'Xyz', 'Features'],
  }),
  component('menuBar', 'Menu Bar', ['Common', 'Navigation'], 'Menu', 250, 34, {
    options: ['File', 'Edit', 'View', 'Help'],
  }),
  component('menu', 'Menu', 'Navigation', 'PanelTopClose', 150, 167, {
    options: [
      'Open,CTRL+O',
      'Open Recent >',
      '---',
  ...
  component('playback', 'Playback', 'Navigation', 'CirclePlay', 120, 40, {
    options: ['rew', 'play', 'ff'],
  }),
  component('toolbar', 'Toolbar', 'Navigation', 'Rows3', 230, 32, {
    options: ['B', 'I', 'U', 'link', 'align'],
  }),
  ...
  component('browser', 'Browser Window', ['Common', 'Containers'], 'PanelTop', 220, 160, {
    text: 'A Web Page\nhttps://',
    fill: '#ffffff',
    showBorder: true,
    showScrollbar: true,
  }),
  component('window', 'Window', ['Common', 'Containers'], 'PanelTop', 220, 160, {
    text: 'Window Name',
    showScrollbar: true,
  }),
  component('modalScreen', 'Modal Screen', 'Containers', 'PanelTop', 220, 140, { fill: '#777777' }),
  component('fieldSet', 'Field Set', 'Containers', 'SquareDashed', 220, 170, {
    text: 'Group Name',
    fill: '#ffffff',
  }),
  component('popover', 'Popover', 'Containers', 'MessageSquare', 160, 105, {
    text: '',
    fill: '#ffffff',
  }),
  component('tooltip', 'Tooltip', 'Containers', 'MessageCircle', 165, 74, {
    text: 'a tooltip',
    fill: '#ffffff',
  }),
  component('callout', 'Callout', 'Containers', 'CircleAlert', 86, 86, {
    text: '1',
    fill: '#fff300',
    fontSize: 28,
  }),

  component('list', 'List', 'Data', 'List', 140, 130, {
    options: ['Item One', 'Item Two', 'Item Three'],
    showBorder: true,
    fill: '#ffffff',
    opacity: 100,
  }),
  component('listIcon', 'List with Icons', 'Data', 'ListChecks', 170, 130, {
    options: ['Item One', 'Item Two', 'Item Three'],
  }),
  ...
  component('siteMap', 'Site Map', 'Data', 'Network', 210, 130, {
    options: ['Home', 'About', 'Products', 'Contact'],
  }),
  component('streetMap', 'Map', 'Data', 'Map', 160, 120, { fill: '#eef2e8' }),
  component('tagCloud', 'Tag Cloud', 'Data', 'Tags', 250, 105, {
    text: 'wireframe mockup UI design notes',
    fontSize: 14,
  }),
  ...
  component('hScrollBar', 'H.Scroll Bar', 'Charts', 'PanelBottom', 180, 28, {
    orientation: 'horizontal',
  }),
  component('vScrollBar', 'V.Scroll Bar', ['Common', 'Charts'], 'PanelRight', 28, 180, {
    orientation: 'vertical',
  }),
  component('hSlider', 'Slider', 'Charts', 'SlidersHorizontal', 170, 36, {
    orientation: 'horizontal',
    value: 55,
  }),
  component('vSlider', 'V.Slider', 'Charts', 'SlidersVertical', 36, 170, {
    orientation: 'vertical',
    value: 55,
  }),
  ...
  component('hCurlyBrace', 'H. Curly Brace', 'Markup', 'Braces', 180, 46, {
    text: 'A paragraph of text.\nA second row of text.',
  }),
  component('vCurlyBrace', 'V. Curly Brace', 'Markup', 'Braces', 56, 160, {
    text: 'A paragraph of text.\nA second row of text.',
  }),
  component('shape', 'Shape', ['Common', 'Markup'], 'Circle', 95, 95, { fill: '#ffffff' }),

  component('image', 'Image', ['Common', 'Media'], 'Image', 140, 120, {
    text: '',
    fill: '#ffffff',
    showBorder: false,
  }),
  ...
  component('iosMenu', 'iOS Menu', 'iOS', 'List', 120, 170, {
    options: ['Label', 'Label', 'Label', 'Label'],
  }),
  component('iosPicker', 'iOS Picker', 'iOS', 'PanelBottom', 150, 130, {
    options: ['08', '09', '10', 'AM', 'PM'],
  }),
];
...
export function isMultilineTextNode(
  node: CanvasNode,
  ...
  if (
    ['dataGrid', 'stickyNote', 'textArea', 'textParagraph', 'squigglyParagraph'].includes(node.kind)
  )
    return true;
...
export function parseOptionsEditDraft(node: CanvasNode, draft: string) {
  if (usesCommaSeparatedOptions(node))
    return draft
      .split(',')
      .map((item) => item.trim())
      .filter(Boolean);
...
export function textEditDraft(node: CanvasNode) {
  if ((node.kind === 'searchBox' || node.kind === 'searchBoxVoice') && !node.text)
...
export function parseTreePaneRows(node: CanvasNode): TreePaneRow[] {
  return nodeOptions(node).map((rawRow, index) => {
    ...
    const label = markerMatch
      ? trimmed.slice(markerMatch[0].length).trimStart()
      : trimmed.trimStart();
...
export function linkableElementsForNode(node: CanvasNode): LinkableElement[] {
  ...
  if (node.kind === 'datePicker')
    return ['CANCEL', 'OK'].map((label, index) => ({
      key: linkKeyForIndex('item', label, index),
      label,
    }));
  ...
  if (node.kind === 'checkboxList' || node.kind === 'radioButtonGroup') {
    return nodeOptions(node).map((item, index) => ({
      key: linkKeyForIndex('item', item, index),
      label: item.replace(/^[-\s[\]x()]+/i, '').trim() || `Item ${index + 1}`,
    }));
  }
  if (node.kind === 'treePane') {
    return parseTreePaneRows(node).map((row) => ({
      key: row.key,
  ...
  if (node.kind === 'alertBox' || node.kind === 'alertBoxAndroid') {
    return nodeOptions(node, ['No', 'Yes']).map((item, index) => ({
      key: linkKeyForIndex('item', item, index),
      label: item || `Button ${index + 1}`,
    }));
  }
  if (node.kind === 'appBar') {
    return nodeOptions(node, ['Menu', 'ChevronDown', 'MoreVertical']).map((item, index) => ({
      key: linkKeyForIndex('item', item, index),
      label: item || `Icon ${index + 1}`,
    }));
  }
  if (
    [
  ...
  if (
    ['text', 'textLabel', 'textTitle', 'textSubtitle', 'textParagraph', 'link'].includes(node.kind)
  ) {
    return [
      ...extractMarkdownLinks(node.text ?? '').map((link) => ({
        key: `text:${linkKeyFromLabel(link, 'link')}`,
        label: link,
      })),
      whole,
    ];
...
export function nodePropertyCapabilities(node: CanvasNode) {
  ...
  const genericStateKinds: ComponentKind[] = [
    'button',
    'checkbox',
    'comboBox',
    'dateChooser',
  ...
  return {
    ...
    genericTextStyle:
      ...
      !isArrow &&
      !isTextNode &&
      genericTextStyleKinds.includes(node.kind),
...
export function commonNodePropertyCapabilities(nodes: CanvasNode[]): NodePropertyCapabilities {
  ...
  const every = (key: keyof NodePropertyCapabilities) =>
    capabilities.length > 0 && capabilities.every((item) => item[key]);
  return {
...
export function nodesShareGenericPaintControls(nodes: CanvasNode[]) {
  return (
    ...
    nodes.every((node) => {
      const capabilities = nodePropertyCapabilities(node);
      return (
        !capabilities.isTextNode &&
        !capabilities.isTabs &&
        !capabilities.isAppBar &&
        !capabilities.isArrow
      );
    })
  );
}
