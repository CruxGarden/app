# Skill: mood-design
Use when: composing or restyling the look — Mood, theme, colors, shape, motion.
...
- A Mood's sound is one looping track the person picks under Mood → Sound; there is no tool for it — say so if asked.
