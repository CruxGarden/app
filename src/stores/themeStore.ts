...
if (typeof document !== 'undefined') {
  ...
  const moodKey = initialResolved === ThemeMode.Light ? SettingsKey.MoodPresetLight : SettingsKey.MoodPresetDark;
...
export const useThemeStore = create<ThemeState>((set) => ({
  ...
  setMode: (mode) => {
    ...
    const key = activeMode === ThemeMode.Light ? SettingsKey.MoodPresetLight : SettingsKey.MoodPresetDark;
