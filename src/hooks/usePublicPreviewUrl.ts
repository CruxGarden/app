 ...
 *
 * This is the LOCAL DEV fallback — only used when VITE_PUBLISH_ORIGIN_TEMPLATE
 * is not set. In production, the iframe points directly to the per-crux subdomain.
 *
