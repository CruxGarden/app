...
export const MOOD_PRESETS: MoodPresetDef[] = [
  ...
  { id: 'obsidian', name: 'Obsidian', section: 'Dark', overrides: {
    ...
    accent: '#c9c9c9', border: '#353638',
    text: '#d5d8d9', textMuted: '#9b9b9b',
    paneCollaboration: '#b88f82', paneArtifacts: '#cdb27d', paneWorkshop: '#aab882',
    paneDetails: '#7fc29a', paneHistory: '#7fa7c2', paneExport: '#7f8dc2',
    paneSync: '#8f82b8', panePublish: '#bf8a97', paneStore: '#b5a78d',
    ...ghostPanes({
  ...
  { id: 'slate', name: 'Slate', section: 'Dark', overrides: {
    ...
    accent: '#79a0d3', border: '#34353d',
    text: '#d4d9e3', textMuted: '#7a88bc',
    paneCollaboration: '#b88f82', paneArtifacts: '#cdb27d', paneWorkshop: '#aab882',
    paneDetails: '#7fc29a', paneHistory: '#7fa7c2', paneExport: '#7f8dc2',
    paneSync: '#8f82b8', panePublish: '#bf8a97', paneStore: '#b5a78d',
    ...ghostPanes({
  ...
  { id: 'moss', name: 'Moss', section: 'Dark', overrides: {
    ...
    accent: '#88bc88', border: '#353835',
    text: '#d5dad5', textMuted: '#86a186',
    paneCollaboration: '#b88f82', paneArtifacts: '#cdb27d', paneWorkshop: '#aab882',
    paneDetails: '#7fc29a', paneHistory: '#7fa7c2', paneExport: '#7f8dc2',
    paneSync: '#8f82b8', panePublish: '#bf8a97', paneStore: '#b5a78d',
    ...ghostPanes({
  ...
  { id: 'ember', name: 'Ember', section: 'Dark', overrides: {
    ...
    accent: '#d38679', border: '#383535',
    text: '#dad5d5', textMuted: '#a18686',
    paneCollaboration: '#b88f82', paneArtifacts: '#cdb27d', paneWorkshop: '#aab882',
    paneDetails: '#7fc29a', paneHistory: '#7fa7c2', paneExport: '#7f8dc2',
    paneSync: '#8f82b8', panePublish: '#bf8a97', paneStore: '#b5a78d',
    ...ghostPanes({
  ...
  { id: 'cafe', name: 'Café', section: 'Dark', overrides: {
    ...
    accent: '#dcae69', border: '#393732',
    text: '#dbd8d0', textMuted: '#a79a7f',
    paneCollaboration: '#b88f82', paneArtifacts: '#cdb27d', paneWorkshop: '#aab882',
    paneDetails: '#7fc29a', paneHistory: '#7fa7c2', paneExport: '#7f8dc2',
    paneSync: '#8f82b8', panePublish: '#bf8a97', paneStore: '#b5a78d',
    ...ghostPanes({
  ...
  { id: 'ivory', name: 'Ivory', section: 'Light', overrides: {
    ...
    accent: '#47473d', border: '#c7c4ba',
    text: '#0f0f0a', textMuted: '#616153',
    accentMuted: 'rgba(80,80,72,0.12)',
    paneCollaboration: '#903424', paneArtifacts: '#77521e', paneWorkshop: '#515214',
    paneDetails: '#265f18', paneHistory: '#14524a', paneExport: '#1e4278',
    paneSync: '#352a6c', panePublish: '#7f203f', paneStore: '#523914',
    ...ghostPanes({
  ...
  { id: 'mist', name: 'Mist', section: 'Light', overrides: {
    ...
    accent: '#2a4d77', border: '#b8c1d1',
    text: '#060b14', textMuted: '#43596f',
  ...
  { id: 'sage', name: 'Sage', section: 'Light', overrides: {
    ...
    accent: '#2e6526', border: '#bbc8b5',
    text: '#081105', textMuted: '#46663b',
  ...
  { id: 'rose', name: 'Rose', section: 'Light', overrides: {
    ...
    accent: '#8a293f', border: '#c7baba',
    text: '#17070b', textMuted: '#6f434e',
  ...
  { id: 'parchment', name: 'Parchment', section: 'Light', overrides: {
    ...
    accent: '#6e4513', border: '#ccbaa1',
    text: '#140e06', textMuted: '#664e2e',
