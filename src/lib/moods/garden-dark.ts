...
export const GARDEN_DARK = {
  ...
  accentMuted: 'color-mix(in srgb, var(--accent) 15%, transparent)',
  link: 'var(--accent)',
  ...
  landingButton: 'var(--accent)',
  landingButtonHover: 'color-mix(in srgb, var(--accent) 85%, black)',
  spinner: 'var(--accent)',
  spinnerTrack: 'var(--border)',
  flowColor: 'var(--accent)',
  iconButtonIconHover: 'var(--accent)',
  iconButtonHover: 'color-mix(in srgb, var(--accent) 15%, transparent)',
  actionButtonHover: 'color-mix(in srgb, var(--accent) 15%, transparent)',
  ...
  gardenCardHover: 'color-mix(in srgb, var(--accent) 15%, transparent)',
  gardenCardBorderHover: 'color-mix(in srgb, var(--accent) 30%, transparent)',
  ...
  keeperConsoleBorder: 'var(--border)',
  keeperConsoleSidebarBorder: 'var(--border)',
  keeperConsoleInputBorder: 'var(--border)',
  ...
  landingPanel: 'var(--surface-solid)',
  commandPaletteInput: 'var(--surface-solid)',
  keeperConsoleInput: 'var(--surface-solid)',
  ...
  keeperConsole: 'var(--panel)',
  keeperConsoleSidebar: 'var(--surface)',
  ...
  toolbar: 'var(--surface-solid)',
  publicTopBar: 'var(--surface-solid)',
  ...
  syntaxAttribute: 'var(--pane-workshop)',
