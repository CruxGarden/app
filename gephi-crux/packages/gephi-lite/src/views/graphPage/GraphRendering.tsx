...
const sigmaSettings: Partial<Settings> = {
  // Leave room for native labels at the edge of a narrow Workshop canvas.
  stagePadding: 80,
...
export const GraphRendering: FC = () => {
  ...
  useEffect(() => {
    ...
    // Workshop and native side panels resize the canvas without resizing the
    // browser window. Keep Sigma aligned with its actual available space.
    let frame = 0;
    ...
    observer.observe(sigma.getContainer());
    return () => {
