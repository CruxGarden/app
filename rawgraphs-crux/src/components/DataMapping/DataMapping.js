...
function DataMapping({ dataTypes, dimensions, mapping, setMapping }, ref) {
  ...
  // Native imports restore the committed mapping after the dataset mounts this panel.
  // Keep transient drag state local, but reflect every new committed mapping.
  useEffect(() => {
